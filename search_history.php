...
if(isset($_POST['submit'])){
    ...
    $data11 = $_POST['search1'];
    $data22 = $_POST['search2'];
...
<body>
<div class="container">
    <h1 class="text text-center">Qidiruv haqidagi ma'lumot</h1><br>

    <div style="display: inline-block; margin-left: 20px" >
        <a href="history.php" class="btn btn-primary">Orqaga </a>
    </div>
    ...
    <div class="col-lg-3 col-md-4" style="display: inline-block; width: 40%; margin-left: 600px">
        <div class="b-search">
            ...
            <form action="search_history.php" method="post">
                ...
                <input style="height: 35px; display: inline-block" type="date" placeholder="Dan.." name="search">
                <b>Dan..</b>
                <input style="height: 35px; margin-left: 20px;" type="date" placeholder="Gacha.." name="search">
                <b>Gacha..</b>
                <button style="height: 35px; margin-bottom: 5px; margin-left: 40px"  type="submit" class="btn btn-primary"> ok </button>
        ...
        <table class="table">
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                foreach ($data1 as $data){
                    ...
                    if ($data['dataa']>=$data11 && $data['dataa']<=$data22){
